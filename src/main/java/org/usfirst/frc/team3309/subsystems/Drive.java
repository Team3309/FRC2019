...
public class Drive extends Subsystem {
    ...
    private WPI_TalonFX driveLeftMaster;
    private WPI_TalonFX driveRightMaster;
    ...
    public Drive() {
        ...
        WPI_TalonFX driveLeftSlave1 = new WPI_TalonFX(Constants.DRIVE_LEFT_SLAVE_FALCON_ID);
        driveRightMaster = new WPI_TalonFX(Constants.DRIVE_RIGHT_MASTER_FALCON_ID);
        WPI_TalonFX driveRightSlave1 = new WPI_TalonFX(Constants.DRIVE_RIGHT_SLAVE_FALCON_ID);
